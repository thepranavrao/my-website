 ...
 *   answer  : the grading + reveal part, kept on the server until an answer is submitted.
...
const BANK = {
  ...
  simulation: [
    {
      payload: {
        label: 'Scenario 1 · Responding as a witness', branch: 'Branch 1 of 3',
    ...
    {
      payload: {
        label: 'Scenario 2 · You receive a complaint', branch: 'Branch 2 of 3',
...
module.exports = { MODULES, MODULE_ORDER, BANK };
